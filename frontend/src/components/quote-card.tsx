...
export function QuoteCard({ quote, onDeleted, onUpdated }: QuoteCardProps) {
  ...
  return (
    <article className="border-b border-border last:border-0 group">
      ...
      {/* Quote text */}
      <blockquote className={`text-3xl leading-relaxed text-foreground font-[350] ${isChinese ? "font-[family-name:var(--font-noto-serif-sc)]" : "font-[family-name:var(--font-geist-sans)]"}`}>
        {quote.text}
      </blockquote>
